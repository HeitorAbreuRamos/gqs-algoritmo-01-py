...
Nivel 3: Exemplo de entrada e saída
...
• Ela utiliza expressão regular para remover todos os caracteres que não sejam letras sem acento ou números (como espaços, hífens e vírgulas). Em seguida, converte todo o texto para letras minúsculas (.lower()), garantindo uma comparação padronizada.
...
https://www.linkedin.com/in/heitor-ramos-9b0305376
